...
class TrainerBase:
        ...
        with EventStorage(start_iter) as self.storage:
            try:
                ...
                for self.iter in range(start_iter, max_iter):
                    self.before_step()
                    self.run_step() #SCD-Net-main/xmodaler/engine/bit_diffusion_trainer.py line 29
                    self.after_step(start_time, best_cider) #xmodaler/engine/hooks.py line 406
    ...
    def after_step(self, start_time, best_cider):
        for h in self._hooks:
            h.after_step(start_time, best_cider)
