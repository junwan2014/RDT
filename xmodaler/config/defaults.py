...
_C.DATALOADER.REF_SENT_FILE = ""

_C.DATALOADER.REF_SENT_RAND_RATIO = 0.0

_C.DATALOADER.INFERENCE_TRAIN = False

_C.DATALOADER.CASCADED_FILE = ""

_C.DATALOADER.CASCADED_SENT_RAND_RATIO = 0.0

_C.DATALOADER.KD_PRED_FILE = ''

_C.DATALOADER.USE_KD_TOKENS_AS_INPUT = False
...
_C.DIFFUSION.NOISE_SCHEDULE = "cosine" # ["cosine", "linear"]
...
_C.MODEL.TOKEN_EMBED.FREEZE_EMBED = False

_C.MODEL.TOKEN_EMBED.BIT_SCALE = 1.0
...
_C.MODEL.BERT.QK_DIM = 49
_C.MODEL.BERT.SCALE = 0.102
_C.MODEL.BERT.TOPK = 30
_C.MODEL.BERT.DIFF_ROUTING = False
_C.MODEL.BERT.PARAM_ROUTING = False
_C.MODEL.BERT.MUL_WEIGHT = "none"
...
_C.LOSSES.RANKLOSS = 100

_C.LOSSES.MARGIN = 0.2

_C.LOSSES.MAX_VIOLATION = True

_C.LOSSES.CLS_LOSS_WEIGHT = 1.0
...
_C.DECODE_STRATEGY.DIFFUSION = CN()

_C.DECODE_STRATEGY.DIFFUSION.TIMESTEPS = 20

_C.DECODE_STRATEGY.DIFFUSION.TIME_DIFFERENCE = 7.0

_C.DECODE_STRATEGY.DIFFUSION.SAMPLE_NOISE = False

_C.DECODE_STRATEGY.DIFFUSION.CAS_TIMESTEPS = []

_C.DECODE_STRATEGY.DIFFUSION.CAS_TIME_DIFFERENCE = []
...
# Misc options
# ---------------------------------------------------------------------------- #
_C.OUTPUT_DIR = "./output/stage1/rl"
