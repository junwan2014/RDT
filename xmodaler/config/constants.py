...
_K.R_TOKENS_IDS = 'R_TOKENS_IDS'

_K.C_TOKENS_IDS = 'C_TOKENS_IDS'
...
_K.R_TOKENS_TYPE = 'R_TOKENS_TYPE'

_K.U_TOKEN_EMBED = 'U_TOKEN_EMBED'

_K.G_TOKEN_EMBED = 'G_TOKEN_EMBED'

_K.R_TOKEN_EMBED = 'R_TOKEN_EMBED'
...
_K.EXT_R_TOKENS_MASKS = 'EXT_R_TOKENS_MASKS'

_K.R_TOKENS_MASKS = 'R_TOKENS_MASKS'
...
_K.BS_REWARDS = 'BS_REWARDS'
_K.SA_REWARDS = 'SA_REWARDS'
...
########################################## Bit Diffusion ##########################################
_K.SELF_COND = 'SELF_COND'

_K.U_TOKENS_IDS_BIT = 'U_TOKENS_IDS_BIT'
